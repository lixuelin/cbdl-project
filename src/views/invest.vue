    ...
    <div class="invest-module">
      ...
      <div class="invest-module-bank">
        <ul>
          ...
          <li class="invest-module-bank-other">
            <div>
              <span>其他金额:</span>
            </div>
            <div class="invest-module-bank-other-set">
              <button type="button" @click="minusMoney">-</button>
              <input type="text" placeholder="输入金额" v-model="set_money" readonly />
              <button type="button" @click="plusMoney">+</button>
            </div>
          </li>
        </ul>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      invest_check_money: [1000, 2980, 5000, 10000, 11400, 19800, 25600, 30000],
      checked_pay: {
        index: null,
        pay: "转账"
      },
  ...
  methods: {
    ...
    checkInvestPay(index) {
      ...
      if (index === 0) {
        ...
        if (this.checked_money.index === null && Number(this.set_money) === 0) {
        ...
        if (
          ...
          this.checked_money.money = Number(this.set_money);
          this.show_text_trade = true;
        } else {
