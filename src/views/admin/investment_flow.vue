  ...
  <div id="investment_flow" class="admin-main">
    ...
    <div class="admin-main-search">
      <div class="admin-main-search-box">
        ...
        <div class="admin-main-search-box-fields">
          <span>银行卡号：</span>
          <Input v-model="search.card" placeholder="请输入银行卡号" clearable style="width: 200px" />
        </div>
        <div class="admin-main-search-box-fields">
          <span>户主姓名：</span>
      ...
      <div class="admin-main-search-box">
        ...
        <div class="admin-main-search-box-fields">
          <div class="admin-main-search-box-btns">
            <Button type="primary" @click="getInvestList(1)">搜索</Button>
    ...
    <Modal v-model="change_invest" width="460">
      ...
      <div class="admin-main-verify">
        ...
        <div class="admin-main-verify-line">
          <label>实际到账金额:</label>
          <input type="text" v-model="invest_info.verify_num" placeholder="请输入实际到账金额！" />
        </div>
      </div>
      <div slot="footer">
        <Button
                  ...
                  "Button",
                  {
                    ...
                    on: {
                      click: () => {
                        ...
                        this.invest_info.verify_num = params.row.invest_num;
                      }
                    }
                  },
                  "未审核"
