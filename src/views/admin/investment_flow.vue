	...
	<div id="investment_flow" class="admin-main">
		...
		<div class="admin-main-search">
			<div class="admin-main-search-box">
				...
				<div class="admin-main-search-box-fields">
					<span>银行卡号：</span> <Input v-model="search.card" placeholder="请输入银行卡号" clearable
					                          style="width: 200px"/>
				</div>
				<div class="admin-main-search-box-fields">
		...
		<Modal v-model="change_invest" width="460">
			...
			<div slot="footer">
				<Button type="primary" size="large" long :loading="modal_loading" @click="verifyInvestNum">确认已到账
				</Button>
			</div>
		</Modal>
	</div>
