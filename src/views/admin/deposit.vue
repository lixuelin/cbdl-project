  ...
  <div class="admin-main">
    ...
    <div class="admin-main-search">
      <div class="admin-main-search-box">
        ...
        <div class="admin-main-search-box-fields">
          <span>户主姓名：</span>
          <Input v-model="search.household" placeholder="请输入户主名称" clearable style="width: 200px" />
        </div>
        <div class="admin-main-search-box-fields">
          <span>审核状态：</span>
      ...
      <div class="admin-main-search-box">
        ...
        <div class="admin-main-search-box-fields">
          <div class="admin-main-search-box-btns">
            <Button type="primary" @click="getBalance(1)">搜索</Button>
          </div>
        </div>
      </div>
    </div>
    ...
    <Modal v-model="change_deposit" width="460">
      ...
      <div class="admin-main-verify">
        ...
        <div class="admin-main-verify-line">
          <label>实际到账金额:</label>
          <input type="text" v-model="deposit_info.reality_num" placeholder="请输入实际到账金额！" />
        </div>
      </div>
      <div slot="footer">
        <Button
...
export default {
                  ...
                  "Button",
                  {
                    ...
                    on: {
                      click: () => {
                        ...
                        this.deposit_info.reality_num = params.row.deposit_num;
  ...
  methods: {
    async getBalance(init_page) {
      ...
      data.currentPage = init_page ? init_page : this.pageInfo.currentPage;
      let res = null;
      try {
    ...
    async del_balance(item) {
      ...
      try {
        res = await this.$Http.deleteBalance(data);
        this.$Message.success("操作成功！");
        this.getBalance();
      } catch (error) {
        if (res.msg) {
