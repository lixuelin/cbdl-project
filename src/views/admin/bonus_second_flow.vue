        ...
        <div class="admin-main-search">
            <div class="admin-main-search-box">
                <div class="admin-main-search-box-fields">
                    <span>分享人账号：</span> <Input v-model="search.username" placeholder="请输入分享人账号" clearable style="width: 200px" />
                </div>
                <div class="admin-main-search-box-fields">
                    <span>分享人姓名：</span> <Input v-model="search.household" placeholder="请输入分享人姓名" clearable style="width: 200px" />
                </div>
                <div class="admin-main-search-box-fields">
                    <span>下层账号：</span> <Input v-model="search.lower_household" placeholder="请输入下层账号" clearable style="width: 200px" />
                </div>
            </div>
            <div class="admin-main-search-box">
                <div class="admin-main-search-box-fields">
