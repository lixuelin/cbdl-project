        ...
        <div class="admin-main-search">
            <div class="admin-main-search-box">
                <div class="admin-main-search-box-fields">
                    <span>收益金额：</span> <Input v-model="search.username" placeholder="请输入用户账号" clearable style="width: 200px" />
                </div>
                <div class="admin-main-search-box-fields">
                    <span>总收益金额：</span> <Input v-model="search.card" placeholder="请输入银行卡号" clearable style="width: 200px" />
                </div>
            </div>
            <div class="admin-main-search-box">
                <div class="admin-main-search-box-fields">
                ...
                <div class="admin-main-search-box-fields">
                    <div class="admin-main-search-box-btns">
                        <Button type="primary" @click="getInvestEveryday">搜索</Button>
            ...
            <div class="admin-main-flow-table">
                <div class="admin-main-flow-table-box">
                    ...
                    <div class="admin-main-flow-page">
                        <Page :total="invest_pageInfo.total" :current="invest_pageInfo.currentPage"
                              :page-size="invest_pageInfo.currentPageSize"
                              @on-change="changePage"/>
                    </div>
                </div>
                <div class="admin-main-flow-table-box">
                    <Table stripe :columns="columns_income" :data="incomes"></Table>
                    <div class="admin-main-flow-page">
                        <Page :total="income_pageInfo.total" :current="income_pageInfo.currentPage"
...
<script>
    import {queryInvestEveryDay, queryIncomeEveryDay} from "./../../utils/admin_api";
