        ...
        <div class="admin-main-search">
            <div class="admin-main-search-box">
                <div class="admin-main-search-box-fields">
                    <span>收益金额：</span> <Input v-model="search.username" placeholder="请输入收益金额" clearable style="width: 200px" />
                </div>
                <div class="admin-main-search-box-fields">
                    <span>总收益金额：</span> <Input v-model="search.card" placeholder="请输入总收益金额" clearable style="width: 200px" />
                </div>
            </div>
            <div class="admin-main-search-box">
                <div class="admin-main-search-box-fields">
