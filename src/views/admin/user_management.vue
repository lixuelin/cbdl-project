<template>
    <div class="admin-main">
            ...
            <div>
                ...
                >
                    ...
                    <FormItem label=" 银行卡号：" prop="cardCheck">
                        <Input
                            v-model="formValidate.cardCheck"
        ...
        <Modal v-model="resetCashModal" width="360">
            ...
            <div slot="footer">
                <Button type="primary" size="large" long @click="resetCashPwd"
                    >重置</Button
                >
            </div>
        </Modal>
        <Modal v-model="resetLoginModal" width="360">
            ...
            <div slot="footer">
                <Button type="primary" size="large" long @click="resetLoginPwd"
                    >重置</Button
                >
            </div>
        </Modal>
