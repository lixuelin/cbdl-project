    ...
    <div class="admin-main">
        ...
        <div class="admin-main-search">
            <div class="admin-main-search-box">
                ...
                <div class="admin-main-search-box-fields">
                    <span>户主：</span> <Input v-model="search.household" placeholder="请输入银行卡号" clearable style="width: 200px" />
                </div>
                <div class="admin-main-search-box-fields">
                    <span>银行卡号：</span> <Input v-model="search.card" placeholder="请输入用户账号" clearable style="width: 200px" />
                </div>
            </div>
            <div class="admin-main-search-box">
                <div class="admin-main-search-box-fields">
