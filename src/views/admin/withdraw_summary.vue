        ...
        <div class="admin-main-search">
            <div class="admin-main-search-box">
                <div class="admin-main-search-box-fields">
                    <span>提现金额：</span> <Input v-model="search.cash_num" placeholder="请输入用户账号" clearable style="width: 200px" />
                </div>
                <div class="admin-main-search-box-fields">
                    <span>提现时间：</span>
            ...
            <div class="admin-main-flow-table">
                <div class="admin-main-flow-table-box">
                    ...
                    <div class="admin-main-flow-page">
                        <Page :total="principal_pageInfo.total" :current="principal_pageInfo.currentPage"
                ...
                <div class="admin-main-flow-table-box">
                    ...
                    <div class="admin-main-flow-page">
                        <Page :total="bonus_pageInfo.total" :current="bonus_pageInfo.currentPage"
    ...
    export default {
        ...
        methods: {
	        ...
	        getCashList() {
		        ...
		        queryCashEveryDay(data).then(response => {
	        ...
	        getCashBonusList() {
		        ...
		        queryCashEveryDayBonus(data).then(response => {
