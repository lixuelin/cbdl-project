    ...
    <div class="b-home-main">
      <div class="b-home-main-means" v-if="true">
        <div class="b-home-main-means-total">
          ...
          <h3>
            <countTo :startVal='total.startVal' :endVal='total.endVal' :duration='total.speed' :decimals="total.float"></countTo>
          </h3>
        </div>
        <div class="b-home-main-means-class">
          <div class="b-home-main-means-class-money">
            ...
            <h4>
              <countTo :startVal='income.startVal' :endVal='income.endVal' :duration='income.speed' :decimals="income.float"></countTo>
            </h4>
          </div>
          <div class="b-home-main-means-class-money">
            <p class="b-home-main-means-tip">分享奖金</p>
            <h4>
              <countTo :startVal='bonus.startVal' :endVal='bonus.endVal' :duration='bonus.speed' :decimals="bonus.float"></countTo>
            </h4>
          </div>
        </div>
      </div>
