    ...
    <div class="income">
        <div class="income-count">
            ...
            <div class="income-count-btn">
                ...
                <template v-else>
                    <i-button type="primary" @click="cashAll"
                        >全部提现</i-button
                    >
                </template>
    ...
    methods: {
        ...
        cashAll() {
            ...
            this.cash_info = {
                ...
                cash:
                    Number(this.total.endVal) -
                    Number(invest_brokerage).toFixed(2),
