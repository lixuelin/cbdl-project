    ...
    <div class="forget-form">
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
        <FormItem label="账户名称" prop="username">
          <Input type="text" v-model="formValidate.username" placeholder="请输入账户名称" />
        </FormItem>
        <FormItem label="银行卡号" prop="card">
          <Input type="text" v-model="formValidate.card" placeholder="请输入绑定银行卡号" />
        </FormItem>
        <FormItem label="所属银行">
          <span>{{ formValidate.bank_name }}</span>
        </FormItem>
        <FormItem label="户主" prop="household">
          <Input type="text" v-model="formValidate.household" placeholder="请输入户主" />
        </FormItem>
      ...
      <div class="admin-main-verify">
        <Form ref="user_pwd" :model="user_pwd" :rules="pwdValidate" :label-width="20">
          <FormItem label=" " prop="password">
            <Input type="password" v-model="user_pwd.password" placeholder="请设置最新密码" />
          </FormItem>
          <FormItem label=" " prop="passwordCheck">
            <Input type="password" v-model="user_pwd.passwordCheck" placeholder="请重新输入密码" />
          </FormItem>
        </Form>
      </div>
      <div slot="footer">
